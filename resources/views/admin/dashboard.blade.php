          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center mb-2">
                <div class="col">
                  <h2 class="h5 page-title">مرحباً بك!</h2>
                </div>
                <div class="col-auto">
                  <form class="form-inline">
                    <div class="form-group d-none d-lg-inline">
                      <label for="reportrange" class="sr-only">تحديد الفترة</label>
                  ...
                  <div class="card-body">
                    <div class="row mt-1 align-items-center">
                      <div class="col-12 col-lg-4 text-left pl-4">
                        <p class="mb-1 small text-muted">إجمالي الإيرادات</p>
                        <span class="h3">{{ number_format($totalRevenue, 2) }}EGP</span>
                        <span class="small text-muted">+20%</span>
                        <span class="fe fe-arrow-up text-success fe-12"></span>
                        <p class="text-muted mt-2">مقارنة بالشهر الماضي الأرقام تعكس نمواً ملحوظاً في حجم المبيعات الإجمالي للمتجر.</p>
                      </div>
                      <div class="col-6 col-lg-2 text-center py-4">
                        <p class="mb-1 small text-muted">مبيعات اليوم</p>
                        <span class="h3">{{ number_format($todaySales, 2) }} EGP</span><br />
                        <span class="small text-muted">+20%</span>
                        <span class="fe fe-arrow-up text-success fe-12"></span>
                      </div>
                      <div class="col-6 col-lg-2 text-center py-4 mb-2">
                        <p class="mb-1 small text-muted">إجمالي الطلبات</p>
                        <span class="h3">{{ $totalOrders }}</span><br />
                        <span class="small text-muted">+6%</span>
                        <span class="fe fe-arrow-up text-success fe-12"></span>
                      </div>
                      <div class="col-6 col-lg-2 text-center py-4">
                        <p class="mb-1 small text-muted">العملاء النشطون</p>
                        <span class="h3">{{ $activeCustomers }}</span><br />
                        <span class="small text-muted">+12%</span>
                        <span class="fe fe-arrow-up text-success fe-12"></span>
                      </div>
                      <div class="col-6 col-lg-2 text-center py-4">
                        <p class="mb-1 small text-muted">نسبة التحويل</p>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row border-top">
                        <div class="col-md-6 pt-4">
                          <h6 class="mb-0">${{ $cost }} <span class="small text-muted">+37.7%</span></h6>
                          <p class="mb-0 text-muted">Cost</p>
                        </div>
                        <div class="col-md-6 pt-4">
                          <h6 class="mb-0">${{ $totalRevenue }} <span class="small text-muted">-18.9%</span></h6>
              ...
              <div class="row">
                ...
                <div class="col-md-12 col-lg-8">
                  <div class="card shadow">
                    <div class="card-header">
                      <strong class="card-title">أحدث الطلبات</strong>
                      <a class="float-right small text-muted" href="{{ route('admin.orders.index')}}">عرض الكل</a>
                    </div>
                      ...
                      <table class="table table-striped table-hover table-borderless">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>#ORD-{{ $order->id }}</td>
                            <th scope="col">  {{ $order->customer_name ?? optional($order->customer)->name ?? 'غير معروف' }}</th>
