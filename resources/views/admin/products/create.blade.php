                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="input-group">
                        <input type="number" name="sale_price" class="form-control" id="salePrice" placeholder="0.00" value="{{ old('sale_price') }}">
                        @error('sale_price')
                          <small class="text-danger">{{ $message }}</small>
                        @enderror
                        <div class="input-group-append">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="number" name="cost_price" class="form-control" id="costPrice" placeholder="0.00" value="{{ old('cost_price') }}">
                      @error('cost_price')
                        <small class="text-danger">{{ $message }}</small>
                      @enderror
                      <div class="input-group-append">
                    ...
                    <div class="input-group">
                      <input type="number" name="main_stock" class="form-control" id="costPrice" placeholder="0.00" value="{{ old('main_stock') }}">
                      @error('main_stock')
                        <small class="text-danger">{{ $message }}</small>
                      @enderror
                      <div class="input-group-append">
